...
pub async fn create_tables(db: &DatabaseConnection) -> Result<(), sea_orm::DbErr> {
    ...
    for sql in [
        ...
        "ALTER TABLE items ADD COLUMN bonus_strength    INTEGER NOT NULL DEFAULT 0",
        "ALTER TABLE items ADD COLUMN bonus_dexterity   INTEGER NOT NULL DEFAULT 0",
        "ALTER TABLE items ADD COLUMN bonus_knowledge   INTEGER NOT NULL DEFAULT 0",
        "ALTER TABLE items ADD COLUMN bonus_max_hp      INTEGER NOT NULL DEFAULT 0",
        "ALTER TABLE items ADD COLUMN bonus_min_damage  INTEGER NOT NULL DEFAULT 0",
        "ALTER TABLE items ADD COLUMN bonus_max_damage  INTEGER NOT NULL DEFAULT 0",
        "ALTER TABLE items ADD COLUMN bonus_armor       INTEGER NOT NULL DEFAULT 0",
        "ALTER TABLE item_definitions ADD COLUMN bonus_strength    INTEGER NOT NULL DEFAULT 0",
        "ALTER TABLE item_definitions ADD COLUMN bonus_dexterity   INTEGER NOT NULL DEFAULT 0",
        "ALTER TABLE item_definitions ADD COLUMN bonus_knowledge   INTEGER NOT NULL DEFAULT 0",
        "ALTER TABLE item_definitions ADD COLUMN bonus_max_hp      INTEGER NOT NULL DEFAULT 0",
        "ALTER TABLE item_definitions ADD COLUMN bonus_min_damage  INTEGER NOT NULL DEFAULT 0",
        "ALTER TABLE item_definitions ADD COLUMN bonus_max_damage  INTEGER NOT NULL DEFAULT 0",
        "ALTER TABLE item_definitions ADD COLUMN bonus_armor       INTEGER NOT NULL DEFAULT 0",
    ...
    db.execute(Statement::from_string(
        ...
        "CREATE TABLE IF NOT EXISTS items (
            ...
            bonus_knowledge     INTEGER NOT NULL DEFAULT 0,
            bonus_max_hp        INTEGER NOT NULL DEFAULT 0,
            bonus_min_damage    INTEGER NOT NULL DEFAULT 0,
            bonus_max_damage    INTEGER NOT NULL DEFAULT 0,
